...
%\draw [help lines] (-1,-1) grid (5,17); %Zeichnet Raster und vereinfacht damit das Zeichnen
	...
	%W
	\draw (0,1) node[above=5mm] {$1W$} to[short,o-] (0,0)
	to[american inductor] (0,-3);
	\draw (0,-0.8) node[right=1.5mm] {$\bullet$};

	\draw (0,-5) node[above=5mm] {$2W$}
	...
	%U
	\draw (4,1) node[above=5mm] {$1U$} to[short,o-] (4,0)
	to[american inductor] (4,-3);
	\draw (4,-0.8) node[right=1.5mm] {$\bullet$};

	\draw (4,-5) node[above=5mm] {$2U$}
	...
	%Spannungspfeile
	\draw (-0.2,0) to [open, v>=$U_c$] (-0.2,-3);
	\draw (1.8,0) to [open, v>=$U_b$] (1.8,-3);
	\draw (3.8,0) to [open, v>=$U_a$] (3.8,-3);

	\draw (-0.2,-5) to [open, v<=$U_f$] (-0.2,-7.5);
	\draw (1.8,-5) to [open, v<=$U_e$] (1.8,-7.5);
	\draw (3.8,-5) to [open, v<=$U_d$] (3.8,-7.5);
	
	\draw (-0.2,-8.5) to [open, v<=$U_i$] (-0.2,-11);
	\draw (1.8,-8.5) to [open, v<=$U_h$] (1.8,-11);
	\draw (3.8,-8.5) to [open, v<=$U_g$] (3.8,-11);
